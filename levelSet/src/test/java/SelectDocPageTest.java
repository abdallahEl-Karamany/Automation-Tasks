...
public class SelectDocPageTest extends HomePageTest {
    ...
    public void freeDocTest(){
        ...
        Assert.assertEquals(selectDoc.getFreeDocs().size(),2,"Count of free Docs is  not Correct");
    ...
    public void pricedDocsTest(){
        Assert.assertEquals(selectDoc.getDocsWithPrice("30","60").size(),1,"Count of priced Docs Expected to be 1");
